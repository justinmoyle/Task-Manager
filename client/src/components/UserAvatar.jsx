    ...
    <>
      <div>
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button
              className="w-10 h-10 2xl:w-12 2xl:h-12 items-center
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      ...
                      className="text-gray-700 group flex w-full items-center rounded-md px-2 
                            py-2 text-base"
                    >
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      ...
                      className="text-red-600 group flex w-full items-center rounded-md px-2 
                            py-2 text-base"
                    >
